<?php 
      ...
      if (!isset($_SESSION['name'])){
          echo "<div style='margin-left:35%;margin-top:200px;'>
                <div style='text-align: center;background:#7B68EE;color:white;width:50%;padding:10px 10px 20px 10px;font-family:verdana;border-radius:10px;'>
                <h1>Hết phiên đăng nhập</h1>
                <br>
                <h2>Click vào đây để đăng nhập lại</h2>
                <button onclick='dangnhap()' style='height:50px;width:200px;border-radius:100px;background:black;color:white;'>Đăng Nhập</button>
