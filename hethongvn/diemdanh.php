...
<body>
    ...
    <div class="trungtam">
        <table  width="100%">
        	<tr>
        		...
        		<td>
                    <br>
                <button onclick="window.location.href='/hethongvn/diemdanhvangmat.php'">Hiển thị người Vắng Mặt</button>
    ...
    border-collapse: collapse;">
        		   	    <tr>   
                            ...
                            <th width="5%">Điểm danh</th>
                            <th width="8%">Nhiệt độ</th> 
                           ...
                           if($result->num_rows>0){
                                 ...
                                 if ($k){
                                        ...
                                        echo "<tr>
                                                  ...
                                                  <td>Có</td>
                                                  <td>Bình thường</td>
                                                  <td><img width='100%' src='uploads/".$anh."'></td>                          </tr>
                                            ";
                            ...
                            <td>Không</td>
                            <td>Nghỉ học</td>
                            <td><img src='img/canhbao.jpg' width='100%'></td>
                        </tr>" ;
                                  }
                              }
                         }
